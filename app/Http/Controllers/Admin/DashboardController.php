...
class DashboardController extends Controller
{
    ...
    {
        //dump(auth()->user());
        //VirtualCardApi::where('name',Auth::check()?auth()->user()->name_api:Admin::first()->name_api)->first()
       // $admin=Admin::where('id',auth()->user()->id)->first();
       //$name_api=auth()->user()->name_api?auth()->user()->name_api:ApiApp::where('status',true)->first()->name;
        $cardApi = VirtualCardApi::where('name',Auth::check()?auth()->user()->name_api:Admin::first()->name_api)->first();
        //where('name',auth()->user()->name_api)->//Auth::check()?auth()->user()->name_api:ApiApp::where('status',true)->first()->name
        $this->api =  $cardApi;
