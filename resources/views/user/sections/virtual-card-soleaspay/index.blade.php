                    ...
                    <div class="card-wrapper d-flex justify-content-between text-center align-items-center">
                        ...
                        <div class="card-balance">
                            ...
                            <div class="card-content d-flex justify-content-center mt-3">
                                ...
                                @else
                                <div class="card-details">
                                    <a href="{{ setRoute('user.soleaspay.virtual.card.details',$myCard->card_id) }}">
                                        <div class="details-icon">
...
<div class="modal fade" id="unblockCardModal" tabindex="-1" aria-labelledby="unblockCard-modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{setRoute('user.soleaspay.virtual.card.pay.penality')}}" method="POST">
                @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{setRoute('user.soleaspay.virtual.card.delete')}}" method="POST">
                @csrf
                <input type="text" value="" name="card_id" hidden>
                <div class="modal-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form class="card-form row g-4" action="{{ route('user.soleaspay.virtual.card.create') }}" method="POST">
                        @csrf
                    <div class="col-12">
...
@push('script')
    <script>
        $(".active-deactive-btn").click(function(){
            var actionRoute =  "{{ setRoute('user.soleaspay.virtual.card.make.default.or.remove') }}";
