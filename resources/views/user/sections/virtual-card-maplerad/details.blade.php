            ...
            <div class="card-prevew pt-2">
                <div class="preview-list-wrapper">
                    ...
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            <span>{{ __($myCard->address["street"]) }}</span>
                        </div>
                    </div>
                    <div class="preview-list-item">
                        <div class="preview-list-left">
                        ...
                        <div class="preview-list-right">
                            <span>{{ __($myCard->address["state"]) }}</span>
                        </div>
                    </div>
                    <div class="preview-list-item">
                        <div class="preview-list-left">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form class="card-form row g-4" action="{{ route('user.maplerad.virtual.card.fund') }}" method="POST">
                        @csrf
...
<script>
     $(document).ready(function(){
        switcherAjax("{{ setRoute('user.maplerad.virtual.card.change.status') }}");
    })
