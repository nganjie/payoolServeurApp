                    ...
                    <div class="card-wrapper d-flex justify-content-between text-center align-items-center">
                        ...
                        <div class="card-balance">
                            ...
                            <div class="card-content d-flex justify-content-center mt-3">
                                ...
                                @else
                                <div class="card-details">
                                    <a href="{{ setRoute('user.maplerad.virtual.card.details',$myCard->card_id) }}">
                                        <div class="details-icon">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form class="card-form row g-4" action="{{ route('user.maplerad.virtual.card.create') }}" method="POST">
                        @csrf
                    <div class="col-12">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        @include('admin.components.form.input',[
                                            'label'         => __("Numéro Pièce D'identité"),
                                            'name'          => "id_number",
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form class="card-form row g-4" action="{{ route('user.maplerad.virtual.card.fund') }}" method="POST" id="myForm">
                        @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form class="card-form row g-4" action="{{ route('user.maplerad.virtual.card.withdraw') }}" method="POST" id="myForm">
                        @csrf
                        <input type="hidden" name="id">
                    <div class="col-12">
                        <div class="row">
...
@push('script')
    <script>
        $(".active-deactive-btn").click(function(){
            var actionRoute =  "{{ setRoute('user.maplerad.virtual.card.make.default.or.remove') }}";
    ...
    <script>
        ...
        $('.buyCard').on('click', function () {
            ...
            $('#BuyCardModal').find("input[name=card_amount]").keyup(function(){
                    getFees();
                    getPreview();
            });
            ...
            function getLimit() {
                ...
                if($.isNumeric(min_limit) || $.isNumeric(max_limit)) {
                    ...
                    $('#BuyCardModal').find('.limit-show').html("{{ __('Limit') }} "+min_limit_calc + " " + currencyCode + " - " + max_limit_clac + " " + currencyCode);
            ...
            function feesCalculation() {
                ...
                var sender_amount = $('#BuyCardModal').find("input[name=card_amount]").val();
            ...
            function getFees() {
                ...
                $('#BuyCardModal').find(".fees-show").html( parseFloat(charges.fixed).toFixed(2) + " " + currencyCode + " + " + parseFloat(charges.percent).toFixed(2) + "% = " + parseFloat(charges.total).toFixed(2) + " " + currencyCode);
            }
            function getPreview() {
                    var senderAmount = $('#BuyCardModal').find("input[name=card_amount]").val();
                    var charges = feesCalculation();
                    var sender_currency = acceptVar().currencyCode;
                    var sender_currency_rate = acceptVar().currencyRate;
                    console.log(senderAmount)
                    senderAmount == "" ? senderAmount = 0 : senderAmount = senderAmount;
                    console.log('apres : ',senderAmount)
                    // Sending Amount
                    $('#BuyCardModal').find('.request-amount').html("Card Amount: " + senderAmount + " " + sender_currency);
                    ...
                    $('#BuyCardModal').find('.fees').html("Total Charge: " + total_charge + " " + sender_currency);
                    ...
                    $('#BuyCardModal').find('.payable-total').html( pay_in_total + " " + sender_currency);
