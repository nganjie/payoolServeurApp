                ...
                <div class="col-xxxl-3 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="right">
                                <div class="chart" id="admin-profit" data-percent="100"><span>100%</span></div>
                            </div>
                        </div>
                        <div class="user-badge">
                ...
                <div class="col-xxxl-3 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="right">
                                <div class="chart" id="support-ticket" data-percent="{{ $data['ticket_percent'] }}"><span>{{ round($data['ticket_percent'],2) }}%</span></div>
                            </div>
                        </div>
                    </div>
                </div>
